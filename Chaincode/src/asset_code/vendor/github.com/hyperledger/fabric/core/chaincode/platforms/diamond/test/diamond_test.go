...
func TestCar_BuildImage(t *testing.T) {
	...
	spec := &pb.ChaincodeSpec{Type: pb.ChaincodeSpec_DIAMOND, ChaincodeID: &pb.ChaincodeID{Path: chaincodePath}, CtorMsg: &pb.ChaincodeInput{Args: util.ToChaincodeArgs("f")}}
